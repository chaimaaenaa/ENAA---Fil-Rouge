...
export class OverViewComponent {
  ...
  private createLineChart() {
    ...
    if (this.workouts.length > 0) { // L-check li khassna
      new Chart(workoutCtx, {
        type: 'line',
        data: {
          labels: this.workouts.map(data => this.datePipe.transform(data.date, 'MM/dd')),
          datasets: [
            {
              label: 'Calories Burned',
              ...
              borderWidth: 2,
              backgroundColor: 'rgba(80, 200, 120, 0.6)',
              borderColor: 'rgba(0, 100, 0, 1)', // Fix typo: 'rgba(0, 100, 0, 1)'
            },
            {
              label: 'Duration',
    ...
    if (this.activities.length > 0) { // L-check li khassna
      new Chart(activityCtx, {
        type: 'line',
        data: {
          labels: this.activities.map(data => this.datePipe.transform(data.date, 'MM/dd')),
          datasets: [
            {
              label: 'Calories Burned',
              ...
              borderWidth: 2,
              backgroundColor: 'rgba(255, 100, 100, 0.6)',
              borderColor: 'rgba(255, 0, 0, 1)', // Fix typo: 'rgba(255, 0, 0, 1)'
            },
            {
              label: 'Steps',
              ...
              borderWidth: 2,
              backgroundColor: 'rgba(255, 180, 120, 0.6)',
              borderColor: 'rgba(255, 100, 0, 1)', // Fix typo: 'rgba(255, 100, 0, 1)'
            },
            {
              label: 'Distance',
              ...
              borderWidth: 2,
              backgroundColor: 'rgba(255, 200, 200, 0.6)',
              borderColor: 'rgba(255, 0, 100, 1)', // Fix typo: 'rgba(255, 0, 100, 1)'
            },
          ]
        },
        options: {
